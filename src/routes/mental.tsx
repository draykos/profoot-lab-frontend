  ...
  head: () => ({
    meta: [
      { title: "Mental coach — Profoot Lab" },
      {
        name: "description",
        content:
          "Sessioni di preparazione mentale, respirazione, recupero e concentrazione per calciatori.",
      },
      { property: "og:title", content: "Mental coach — Profoot Lab" },
      {
        property: "og:description",
        content: "Preparazione mentale, respirazione e recupero per l'atleta.",
      },
      { property: "og:type", content: "website" },
      { property: "og:url", content: absoluteUrl("/mental") },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [{ rel: "canonical", href: absoluteUrl("/mental") }],
  }),
});
